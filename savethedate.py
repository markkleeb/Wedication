...
for num in range(4,212):  #to iterate between guests, amend this based on your total
    ...
    if not guest_number:
        ...
        client.messages.create(
            ...
            body = "Hello friends! Steph & Mark's wedding is coming up in 17 days and we'd like to know your dinner preference! Here's a Google Form where you can select your options:\n\nhttps://forms.gle/GiDBHxoT4pUS21Ln7\n\nAlso please let us know if you'll be attending brunch the following day! Remember - I'm a dumb robot, so please fill out the form and don't text me back! I don't understand big words. \nEmail greebwedding@gmail.com if you have any questions or problems with the form! We can't wait to see you!"+ u"\U0001f618" + "\n\n" + u"\u2764" + u"\u2728" + u"\U0001f63b"  + u"\U0001F389" + u"\U0001F37E" + u"\U0001F525" + u"\U0001F63D"+ u"\u2764\n",
